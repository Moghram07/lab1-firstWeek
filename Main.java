...
public class Main {
    public static void main(String[] args) {
        ...
        if (compare1 != compare2) {
            ...
            int compNum2 = scanner.nextInt();
            System.out.println("Q.13 Enter third number: ");
            int compNum3 = scanner.nextInt();
            System.out.println("Q.13 Enter forth number: ");
            ...
            do {
                System.out.println("Q.15 Please enter any number ");
            ...
            do {
                ...
                System.out.println("press y continue or press n to exit");
                scanner.nextLine();
